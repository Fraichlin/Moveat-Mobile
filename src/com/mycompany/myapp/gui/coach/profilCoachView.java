 ...
 */
public class profilCoachView extends SideMenuBaseForm{
        public profilCoachView(Resources res,Coach user){
    super(BoxLayout.y());
        ...
        TextField tAdresse = new TextField(user.getAdresse());
        TextField tTel = new TextField(user.getTel());
        ...
        addAll(tName,tSurname,tEmail,tUsername,tPassword,tConfirmPassword,tAdresse,tTel,profilPicture);
            ...
            public void actionPerformed(ActionEvent evt) {
                if(tEmail.getText().equals("")
                    ...
                    try{
                        ...
                        if(new registerCoachService().updateCoach(m))
